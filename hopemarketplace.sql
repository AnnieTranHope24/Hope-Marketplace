...
INSERT INTO `items` (`Name`,`Category`,`Subcategory`,`Price`,`Image`) Values ('ACT Total Prep 2024','academics','testpreps',25.00,'testprep.jpg');
INSERT INTO `items` (`Name`,`Category`,`Subcategory`,`Price`,`Image`) Values ('MCAT 528 Advanced Prep','academics','testpreps',20.00,'testprep1.jpg');
INSERT INTO `items` (`Name`,`Category`,`Subcategory`,`Price`,`Image`) Values ('LSAT PreTest 84','academics','testpreps',10.00,'testprep2.jpg');
INSERT INTO `items` (`Name`,`Category`,`Subcategory`,`Price`,`Image`) Values ('MCAT Physics and Math Review','academics','testpreps',5.00,'testprep3.jpg');
INSERT INTO `items` (`Name`,`Category`,`Subcategory`,`Price`,`Image`) Values ('MCAT Organic Chemistry Review','academics','testpreps',12.00,'testprep4.jpg');
INSERT INTO `items` (`Name`,`Category`,`Subcategory`,`Price`,`Image`) Values ('MCAT Organic Chemistry Review','academics','testpreps',25.00,'testprep5.jpg');
INSERT INTO `items` (`Name`,`Category`,`Subcategory`,`Price`,`Image`) Values ('SAT Subject Test Biology','academics','testpreps',10.00,'testprep6.jpg');
INSERT INTO `items` (`Name`,`Category`,`Subcategory`,`Price`,`Image`) Values ('Comparison Statements','academics','testpreps',15.00,'testprep7.jpg');
INSERT INTO `items` (`Name`,`Category`,`Subcategory`,`Price`,`Image`) Values ('The Little Red Writing Book','academics','testpreps',20.00,'testprep8.jpg');
INSERT INTO `items` (`Name`,`Category`,`Subcategory`,`Price`,`Image`) Values ('Algebra Review','academics','testpreps',20.00,'testprep9.jpg');
INSERT INTO `items` (`Name`,`Category`,`Subcategory`,`Price`,`Image`) Values ('The ACT for Bad Test Takers','academics','testpreps',10.00,'testprep10.jpg');
