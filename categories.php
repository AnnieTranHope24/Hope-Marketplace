...
array("Gym Equipment" => array("Home Workout Equipment", "Fitness Clothes", "Weightlifting Belts","Foam Rollers","Sport Equipment"),
               "Reconver"  => array("Yoga Matts", "Waterbottles", "Bodyweight Scales","Massage Guns"))
);
$categories[] = array("category" => "room", "subcategories" =>
array("Room Decorations" => array("Plants", "Lights", "Rugs", "Art"),
...
$categories[] = array("category" => "technology", "subcategories" =>
                          array("Electronics" => array("Computers & Tablets", "TV & Home Theater", "Cameras","Speakers"),
                                         "Wearable Tech"  => array("Smart Watches", "Headphones", "VR Headsets"),
                                                    "Entertainment"  => array("Video Games", "Movies & Music", "Collectibles"))
);
?>